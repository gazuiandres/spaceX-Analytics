...
exports.default = () => __awaiter(void 0, void 0, void 0, function* () {
    const generalData = yield axios_1.default.post(globalVariables_1.LAUNCHES_URL_API, queries_1.generalFalcon9Query);
    const failsData = yield axios_1.default.post(globalVariables_1.LAUNCHES_URL_API, queries_1.generalFalcon9FailsQuery);
    ...
    fs_1.default.writeFileSync("data/falcon9.json", JSON.stringify(jsonData, null, 4));
});
