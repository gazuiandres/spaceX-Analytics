...
exports.default = () => __awaiter(void 0, void 0, void 0, function* () {
    const generalData = yield axios_1.default.post(globalVariables_1.LAUNCHES_URL_API, queries_1.generalQuery);
    const failsData = yield axios_1.default.post(globalVariables_1.LAUNCHES_URL_API, queries_1.generalFailsQuery);
    ...
    fs_1.default.writeFileSync("data/general.json", JSON.stringify(jsonData, null, 4));
});
